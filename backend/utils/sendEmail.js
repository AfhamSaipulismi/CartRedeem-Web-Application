...
const sendCheckoutEmail = async (order, user) => {
  try {
    ...
    const mailOptions = {
      ...
      to: user.email,
      subject: `🎟️ Order Confirmation - CartRedeem System (Order #${order._id})`,
      html: htmlContent,
      attachments: [
        {
...
const sendOTPEmail = async (email, otp, username) => {
  try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Thank you for registering with CartRedeem System!</p>
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM,
      to: email,
      subject: `🔐 Your OTP Code - CartRedeem System`,
      html: htmlContent,
    };
